...
/*
Recorder;
import lanpechat.ChatClient;
import lanpechat.CommonSoundClass;
import lanpechat.Playback;
import lanpechat.MultiChatConstants;
*/
...
import java.util.*;
import java.net.*;
//this is very much similar to chatclient class call it asist class
...
public class ChatClientApplet extends java.applet.Applet{
    ...
    private void mnuUnmuteActionPerformed(java.awt.event.ActionEvent evt) {
        try{
    ...
    private void chkHandsFreeKeyPressed(java.awt.event.KeyEvent evt) {
